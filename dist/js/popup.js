...
function Popup() {
    var analyze = function () {
        chrome.tabs.query({ active: true, currentWindow: true }, function (tabToScrape) {
            if (tabToScrape && tabToScrape.length > 0 && tabToScrape[0] && tabToScrape[0].id) {
                chrome.tabs.sendMessage(tabToScrape[0].id, { type: 'scrapeHtml' }, function (response) {
    ...
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_1__["default"], __assign({ container: true, sx: { width: '100px', height: '100px' } }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_2__["default"], { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_3__["default"], __assign({ onClick: analyze }, { children: "Check Ingredients" })) }) })));
}
;
